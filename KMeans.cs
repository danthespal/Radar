namespace OriathHub.Plugins.Radar
{
    ...
    /// <summary>
    ///     A double-precision 2D vector, used only as k-means' working precision for grid coordinates.
    /// </summary>
    ...
    /// <summary>
    ///     K-means clustering over 2D points, used to collapse a wildcard tile match spanning many raw
    ///     locations down to a target's <c>ExpectedCount</c> map markers.
    /// </summary>
    internal static class KMeans
    {
        /// <summary>
        ///     Assigns each point in <paramref name="rawData"/> a cluster index in [0, numClusters).
        /// </summary>
